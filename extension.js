...
function activate(context) {
    ...
    console.log('Congratulations, your extension "vs-code-plugin-hello-world-demo" is now active!');
    ...
    disposable = vscode.commands.registerCommand('extension.sayWhatYouSelected', function () {
